...
Google Search MCP Tool Implementation - Refactored
"""
...
class GoogleSearchTool(BaseMCPTool):
    ...
    def get_input_schema(self) -> Dict:
        ...
        return {
            ...
            "properties": {
                ...
                "date_restrict": {
                    "type": "string",
                    "description": "Restrict results by date (e.g., 'd7' for past week, 'm3' for past 3 months, 'y1' for past year)"
                },
                "language": {
                    "type": "string",
                    "description": "Language of results (e.g., 'en', 'es', 'fr')",
                    "default": "en"
                }
            },
            "required": ["query"]
    ...
    def get_output_schema(self) -> Dict:
        """Get output schema for Google Search tool"""
        return {
            "type": "object",
            "properties": {
                "query": {
                ...
                "searchTime": {
                    "type": "number",
                    "description": "Time taken to execute search (seconds)"
                },
                "count": {
                    "type": "integer",
                ...
                "results": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "image": {
                                "type": "object",
                                "description": "Image information (for image search only)",
                                "properties": {
                                    "thumbnailLink": {
                                        "type": "string"
                                    },
    ...
    def execute(self, arguments: Dict[str, Any]) -> Any:
        ...
        return self._search(query, num_results, start, safe_search, search_type, date_restrict, language)
    ...
    def _get_demo_results(self, query: str, arguments: Dict) -> Dict:
        ...
        Returns:
            Mock search results
        """
        num_results = min(arguments.get('num_results', 10), 5)
