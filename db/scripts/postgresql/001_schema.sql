-- ============================================================================
-- SAJHA MCP Server v5.1.0 — PostgreSQL Schema
-- Copyright All rights Reserved 2025-2030, Ashutosh Sinha
-- Generated from SQLAlchemy models (single source of truth).
-- Must be created BEFORE server starts.
-- Run: psql -d sajha -f 001_schema.sql
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS api_keys (
    ...
    usage_count          INTEGER        NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS composite_tool_steps (
    ...
    step_order           INTEGER        DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS llm_models (
    ...
    context_window       INTEGER        DEFAULT FALSE,
    max_output_tokens    INTEGER        ,
    input_cost_per_1k    DOUBLE PRECISION           DEFAULT FALSE,
    output_cost_per_1k   DOUBLE PRECISION           DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS user_sessions (
    ...
    created_at           TIMESTAMPTZ      NOT NULL DEFAULT CURRENT_TIMESTAMPTZ,
    last_activity        TIMESTAMPTZ      NOT NULL DEFAULT CURRENT_TIMESTAMPTZ,
...
CREATE TABLE IF NOT EXISTS llm_usage (
    ...
    timestamp       TIMESTAMPTZ      NOT NULL DEFAULT CURRENT_TIMESTAMPTZ
);
