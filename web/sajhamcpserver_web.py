"""
SAJHA MCP Server Web Application - Main Flask Application Class
...
from core.hot_reload_manager import get_config_reloader
...
class SajhaMCPServerWebApp:
    ...
    def _initialize_managers(self):
        ...
        logger.info(f"Tools registry initialized with {len(self.tools_registry.tools)} tools")
        
        # Prompts Registry
        self.prompts_registry = PromptsRegistry()
        logger.info(f"Prompts registry initialized with {len(self.prompts_registry.prompts)} prompts")
