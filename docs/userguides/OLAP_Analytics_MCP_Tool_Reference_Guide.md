...
Cohort analysis is a powerful technique for understanding how groups of users behave over time. Version 5.0.0 includes two specialized tools for cohort and retention analysis.
...
Version 5.0.0 includes a sample data generator for creating realistic demo datasets.
