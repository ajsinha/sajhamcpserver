...
MCP Studio is a comprehensive visual tool creation platform that allows administrators to create custom MCP tools without manual coding. Version 5.1.0 includes **eight creation methods** with full dark theme support and enhanced OLAP capabilities:
...
### PowerBI DAX Query Tool Creator (NEW in v5.1.0)
...
### IBM LiveLink Document Tool Creator (NEW in v5.1.0)
...
### OLAP Dataset Creator (NEW in v5.1.0)
